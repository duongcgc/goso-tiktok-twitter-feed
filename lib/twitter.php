<?php
/* implement getTweets */
require_once __DIR__ . '/GosoTwitterFeed.class.php';
function goso_getTweets( $count = 20, $username = false, $options = false ) {

	$options_data = get_option( 'goso_options[goso_twitter]' );
	...
	$obj = new GosoTwitterFeed( $config );
